    ...
    <ul class="space-y-2">
        <li>
            <a href="{{ route('admin.dashboard') }}"
                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition-all duration-300 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->routeIs('admin.dashboard') ? 'bg-gray-200 dark:bg-gray-800' : '' }}">
                <svg aria-hidden="true"
                    class="w-6 h-6 text-gray-400 transition duration-300 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white {{ request()->routeIs('admin.dashboard') ? 'text-gray-900 dark:text-white' : '' }}"
